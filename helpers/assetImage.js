...
export const welcome = require('../assets/images/welcome.gif')
export const signIn = require('../assets/images/signIn.png')
export const signUp = require('../assets/images/signUp.png')